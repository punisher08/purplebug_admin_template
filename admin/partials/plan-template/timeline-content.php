...
<div id="create-task" class="modal">
    <form id="creat-task-form" method="POST">
        ...
        <div class="form-group">
            <input name="task-title" required id="task-title" class="input-field task-title-count" maxlength="80" type="text" placeholder="Enter task title here" value="" />
...
<div id="create-event" class="modal">
    <form id="create-event-form" method="POST">
        ...
        <div class="form-group">
            <input name="task-title" required id="task-title" class="input-field task-title-count" maxlength="80" type="text" placeholder="Add Event Name" value="" />
            <p class="ndl-Text ndl-Text--secondary ndl-Input-charCount ndl-CharacterCount">0/80</p>
        </div>
        <div class="form-group">
            <label>
